...
Locator: getByText(/AUTO-4S-20260706123151 Mao de obra/i).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/AUTO-4S-20260706123151 Mao de obra/i).first()
...
- main:
  ...
  - paragraph: 12 categorias cadastradas
    ...
    - rowgroup:
      ...
      - row "4S-988446-2026 AUTO-4S-20260706114042 Mao de obra MATERIAL CUSTO Sim Não ATIVA Editar Excluir":
        ...
        - cell "Editar Excluir":
          - button "Editar"
          - button "Excluir"
  - text: 1-10 de 12 Itens por pagina
  - combobox:
