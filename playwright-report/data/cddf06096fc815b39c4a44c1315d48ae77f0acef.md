...
Locator: getByText(/AUTO-4S-20260706123151 Materiais/i).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/AUTO-4S-20260706123151 Materiais/i).first()
...
- main:
  ...
  - paragraph: 14 categorias cadastradas
    ...
    - rowgroup:
      ...
      - row "4S-707543-2026 AUTO-4S-20260706114042 Materiais MATERIAL CUSTO Sim Não ATIVA Editar Excluir":
        ...
        - cell "Editar Excluir":
          - button "Editar"
          - button "Excluir"
  - text: 1-10 de 14 Itens por pagina
  - combobox:
